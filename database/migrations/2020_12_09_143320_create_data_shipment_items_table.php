...
class CreateDataShipmentItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('data_shipment_items', function (Blueprint $table) {
            $table->increments('data_shipment_item_id')->comment('data_shipment_item_id');
            $table->integer('data_shipment_voucher_id')->comment('data_shipment_voucher_id');
            ...
            $table->string('mes_lis_shi_lin_fre_shipment_item_code',25)->default('')->comment('商品コード（出荷元）');
            ...
            $table->integer('mes_lis_shi_lin_qua_shi_quantity')->default(0)->comment('出荷数量（バラ）');
            $table->integer('mes_lis_shi_lin_qua_shi_num_of_order_units')->default(0)->comment('出荷数量（発注単位数）');
            $table->integer('mes_lis_shi_lin_qua_sto_quantity')->default(0)->comment('欠品数量(バラ数)');
            $table->string('mes_lis_shi_lin_qua_sto_num_of_order_units',20)->default('')->comment('欠品数量(発注単位数)');
            $table->string('mes_lis_shi_lin_qua_sto_reason_code',20)->default('')->comment('欠品区分');
            ...
            $table->string('mes_lis_shi_lin_fre_order_weight',15)->default('')->comment('発注重量');
            $table->string('mes_lis_shi_lin_fre_shipment_weight',15)->default('')->comment('出荷重量');

...
class CreateDataPaymentPayDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('data_payment_pay_details', function (Blueprint $table) {
            ...
            $table->string('mes_lis_pay_lin_det_amo_requested_amount', 20)->comment('請求金額');
            $table->string('mes_lis_pay_lin_det_amo_req_plus_minus', 10)->comment('請求金額符号');
            $table->string('mes_lis_pay_lin_det_amo_payable_amount', 20)->comment('支払金額');
            ...
            $table->string('mes_lis_pay_lin_det_tax_tax_rate', 13)->comment('税率');

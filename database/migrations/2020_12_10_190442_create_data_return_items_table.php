...
class CreateDataReturnItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('data_return_items', function (Blueprint $table) {
            $table->increments('data_return_item_id')->comment('data_return_item_id');
            $table->integer('data_return_voucher_id')->comment('data_return_voucher_id');
            ...
            $table->string('mes_lis_ret_lin_fre_shipment_line_number',10)->default('')->comment('出荷者管理明細番号');
            ...
            $table->string('mes_lis_ret_lin_reason_code',14)->default('')->comment('返品・値引理由コード');
            ...
            $table->string('mes_lis_ret_lin_fre_shipment_item_code',10)->default('')->comment('商品コード（出荷元）');
            ...
            $table->string('mes_lis_ret_lin_qua_quantity',10)->default('')->comment('返品数量（バラ）');
            ...
            $table->string('mes_lis_ret_lin_fre_return_weight',10)->default('')->comment('返品重量');

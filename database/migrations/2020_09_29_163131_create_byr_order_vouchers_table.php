...
class CreateByrOrderVouchersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('byr_order_vouchers', function (Blueprint $table) {
            ...
            $table->string('ship_code', 50)->comment('ship_code')->nullable();
            $table->string('ship_name', 50)->comment('ship_name')->nullable();
            $table->string('ship_name_kana', 50)->comment('ship_name_kana')->nullable();

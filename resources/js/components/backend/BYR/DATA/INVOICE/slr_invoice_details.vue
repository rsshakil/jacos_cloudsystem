...
export default {
  ...
  methods: {
    setRowscodeIntoForm2(valCode){
      ...
      axios.post(this.BASE_URL + "api/slr_get_voucher_detail_popup2_invoice", this.$route.query)
        .then(({ data }) => {
    ...
    invoice_details(page = 1) {
      let loader = Vue.$loading.show();
        this.form.page=page;
      axios.post(this.BASE_URL + "api/slr_get_invoice_details_list", this.form)
        .then(({ data }) => {

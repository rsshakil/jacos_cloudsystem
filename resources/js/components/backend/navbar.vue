  ...
  <main class="main-content p-0">
    <div class="main-navbar sticky-top bg-white">
      ...
      <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
        ...
        <ul class="navbar-nav top_custom_ul border-left flex-row">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-small" style="margin-left: -60px;">
              ...
              <router-link
                :to="{ name: 'users', params: { id: global_user_id,auth_id:global_user_id } }"
                class="dropdown-item"
              >
                <i class="material-icons">&#xE7FD;</i> Profile
              </router-link>
              ...
              <router-link
                :to="{ name: 'password_reset', params: { id: global_user_id,auth_id:global_user_id  } }"

...
methods:{
          loadCanvasData() {
            axios.post(this.BASE_URL+"api/load_canvas_data",{byr_order_id:this.byr_order_id})
                .then(({ data }) => {
          ...
          saveData(){
            ...
            var canvas_data= { canvas_id: this.canvas_id, update_image_info: this.update_image_info,byr_order_id:this.byr_order_id, canvas_name: this.canvas_name, canData: canData, canvasImage: this.getCanvasBgImage() }

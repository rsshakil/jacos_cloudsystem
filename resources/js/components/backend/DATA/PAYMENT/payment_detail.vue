    ...
    <b-modal size="xl" :hide-backdrop="true" title="未払伝票確認" cancel-title="閉じる" v-model="unpaid_slip_modal" :hide-footer="true" :draggable="true">
      ...
      <div class="row">
        ...
        <h6>ダウンロードを押すと、比較データがダウンロードされます</h6>
           <button class="btn btn-outline-primary" style="float:right;margin-bottom:15px;" type="button" :disabled="is_disabled(form.shipment_ids?true:false)" @click="unpaid_data_download(1)">

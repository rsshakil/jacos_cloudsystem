...
beforeCreate: function() {
  ...
  computed: {
    ...
    totalCostPriceVal: function() {
      return this.order_item_detail_lists.reduce(function(sum,order_item_detail_list){return  sum+order_item_detail_list.mes_lis_ret_lin_amo_item_net_price_unit_price * order_item_detail_list.mes_lis_ret_lin_qua_shi_quantity;}, 0)

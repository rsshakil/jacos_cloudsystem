        ...
        <span class="pagi" style="width:100%">
            <ul class="list-inline">
              <li v-for="(item,index) in order_detail_list_paginates" :key="index" v-if="data_order_voucher_id==item.data_shipment_voucher_id">
                <span v-if="index>=1"><button class="btn btn-primary" @click="move_next_prev(order_detail_list_paginates[index-1].data_shipment_voucher_id)">＜前伝票</button></span>
                <span v-if="index<order_detail_list_paginates.length-1"><button class="btn btn-primary" @click="move_next_prev(order_detail_list_paginates[index+1].data_shipment_voucher_id)">次伝票＞</button></span>
      ...
      <div class="col-12">
        <div class="">
          ...
          <table class="table table-striped table-bordered table-responsive order_item_details_table data_table" style="overflow-x: scroll;">
            ...
            <tbody>
              ...
              <tr v-for="(order_item_detail_list, index) in order_item_detail_lists" :key="index">
                ...
                <td>
                <input type="number" :disabled="is_disabled(order_item_shipment_data_headTable.decision_datetime==null?true:false)" class="form-control" @keyup="ball_case_cal(order_item_detail_list,'ケース')" v-model="order_item_detail_list.mes_lis_shi_lin_qua_shi_num_of_order_units">
          ...
          <!--{{order_item_detail_list.mes_lis_shi_lin_qua_unit_of_measure}}  {{getbyrjsonValueBykeyName('mes_lis_ord_lin_qua_unit_of_measure',order_item_detail_list.mes_lis_shi_lin_qua_unit_of_measure,'orders')}}-->
                ...
                <td>
                 <input type="number" :disabled="is_disabled(order_item_shipment_data_headTable.decision_datetime==null?true:false)" class="form-control" @keyup="ball_case_cal(order_item_detail_list,'バラ')" v-model="order_item_detail_list.mes_lis_shi_lin_qua_shi_quantity">
                ...
                <td class="text-right">
                 <input type="number" :disabled="is_disabled(order_item_shipment_data_headTable.decision_datetime==null?true:false)" class="form-control text-right" v-model="order_item_detail_list.mes_lis_shi_lin_amo_item_net_price_unit_price">
                {{order_item_detail_list.mes_lis_ord_lin_amo_item_net_price_unit_price}}</td>
                <td class="text-right">
               
                <span v-if="order_item_detail_list.mes_lis_shi_lin_amo_item_net_price_unit_price * order_item_detail_list.mes_lis_shi_lin_qua_shi_quantity>0"> {{ order_item_detail_list.mes_lis_shi_lin_amo_item_net_price_unit_price * order_item_detail_list.mes_lis_shi_lin_qua_shi_quantity | priceFormat}}</span>
                <span v-else>0</span>
                </td>
                <td class="text-right">

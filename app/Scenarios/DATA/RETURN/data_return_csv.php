    ...
    public function exec($request, $sc)
    {
        ...
        foreach ($dataArr as $key => $value) {
            ...
            if ($rcv_flg) {
                ...
                $data_receive_id = data_return::insertGetId($data_receive_array);
            ...
            if ($trade_number !=$value[31].'-'.$value[32]) {
                ...
                $data_receive_voucher_id = data_return_voucher::insertGetId($data_receive_voucher_array);
            ...
            data_return_item::insert($data_receive_item_array);

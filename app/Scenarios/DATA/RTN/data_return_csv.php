...
class data_return_csv
{
    ...
    public function exec($request, $sc)
    {
        ...
        foreach ($dataArr as $key => $value) {
            ...
            // $data_return_item_array['mes_lis_ret_lin_ite_siz_size_code']=$value[121];
            // $data_return_item_array['mes_lis_ret_lin_ite_siz_description']=$value[122];
            // $data_return_item_array['mes_lis_ret_lin_ite_siz_description_sbcs']=$value[123];

...
class data_return_csv
{
    ...
    public function exec($request, $sc)
    {
        ...
        foreach ($dataArr as $key => $value) {
            ...
            $data_return_item_array['mes_lis_ret_lin_fre_packing_quantity']=$value[100];
            $data_return_item_array['mes_lis_ret_lin_fre_prefecture_code']=$value[101];
            $data_return_item_array['mes_lis_ret_lin_fre_country_code']=$value[102];
            $data_return_item_array['mes_lis_ret_lin_fre_field_name']=$value[103];
            $data_return_item_array['mes_lis_ret_lin_fre_water_area_code']=$value[104];
            $data_return_item_array['mes_lis_ret_lin_fre_water_area_name']=$value[105];
            $data_return_item_array['mes_lis_ret_lin_fre_area_of_origin']=$value[106];
            $data_return_item_array['mes_lis_ret_lin_fre_item_grade']=$value[107];
            $data_return_item_array['mes_lis_ret_lin_fre_item_class']=$value[108];
            $data_return_item_array['mes_lis_ret_lin_fre_brand']=$value[109];
            $data_return_item_array['mes_lis_ret_lin_fre_item_pr']=$value[110];
            $data_return_item_array['mes_lis_ret_lin_fre_bio_code']=$value[111];
            $data_return_item_array['mes_lis_ret_lin_fre_breed_code']=$value[112];
            $data_return_item_array['mes_lis_ret_lin_fre_cultivation_code']=$value[113];
            $data_return_item_array['mes_lis_ret_lin_fre_defrost_code']=$value[114];
            $data_return_item_array['mes_lis_ret_lin_fre_item_preservation_code']=$value[115];
            $data_return_item_array['mes_lis_ret_lin_fre_item_shape_code']=$value[116];
            $data_return_item_array['mes_lis_ret_lin_fre_use']=$value[117];
            $data_return_item_array['mes_lis_ret_lin_ite_siz_size_code']=$value[118];
            $data_return_item_array['mes_lis_ret_lin_ite_siz_description']=$value[119];
            $data_return_item_array['mes_lis_ret_lin_ite_siz_description_sbcs']=$value[120];

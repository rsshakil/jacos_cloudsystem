...
class data_csv_receive_order extends Model
{
    ...
    public function exec($request, $sc)
    {
        ...
        foreach ($dataArr as $key => $value) {
            $exists_voucher = data_receive_voucher::join('data_receives','data_receives.data_receive_id','=','data_receive_vouchers.data_receive_id')
            ...
            $exists_item=$exists_item->where('data_receive_voucher_id', '=', $data_receive_voucher_id)
                ->first();
            if ($exists_item) {

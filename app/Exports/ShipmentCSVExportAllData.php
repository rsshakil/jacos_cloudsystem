...
class ShipmentCSVExportAllData implements FromQuery,WithHeadings,ShouldAutoSize
{
    use Exportable;
    private $request;
    ...
    {
        $shipment_csv_data = Data_Controller::get_shipment_data_download($this->request);

...
class DataController extends Controller
{
    public static function getPaymentData($request)
    {
        ...
        $csv_data=data_payment::select('data_payments.*','data_payment_pays.*','data_payment_pay_details.*')
        ...
        if (!(array_key_exists("downloadType", $request_all))) {
            $csv_data->where('data_payment_pay_details.decision_datetime','!=',null);
            $csv_data->where('data_payment_pay_details.send_datetime','=',null);
        }
        $csv_data->groupBy('data_payment_pay_details.data_payment_pay_detail_id');
        $csv_data->orderBy("data_payments.data_payment_id");
        // 検索

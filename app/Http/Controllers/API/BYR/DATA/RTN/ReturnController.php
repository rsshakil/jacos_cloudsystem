...
class ReturnController extends Controller
{
    ...
    public function get_return_customer_code_list(Request $request)
    {
        ...
        $query = data_return::join('data_return_vouchers as drv', 'drv.data_return_id', '=', 'data_returns.data_return_id')
            ->join('cmn_connects as cc', 'cc.cmn_connect_id', '=', 'data_returns.cmn_connect_id')
            ->select(
                'drv.mes_lis_ret_par_sel_code',
                'drv.mes_lis_ret_par_sel_name',
            ...
            ->where('cc.byr_buyer_id', $byr_buyer_id)
            //->where('cc.slr_seller_id', $slr_seller_id)
            ->groupby('drv.mes_lis_ret_par_sel_code', 'drv.mes_lis_ret_par_pay_code');
        $result = $query->get();

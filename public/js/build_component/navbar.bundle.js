...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.get_user_company_info(); //console.log(Globals.global_user_type);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "main-navbar sticky-top bg_custom_color" }, [
        _c(
          "nav",
          {
            staticClass:
                    ...
                    [
                      _c("router-link", { attrs: { to: "/home" } }, [
                        _c("img", {
                          ...
                          staticStyle: { "max-width": "100%", height: "60px" },
                          attrs: {
                            id: "main-logo",
                            src:
                              _vm.BASE_URL +
                            ...
                            [
                              ...
                              _c(
                                ...
                                _vm._l(_vm.slr_order_list, function(buyer) {
                                  return _c("tr", { key: buyer.byr_buyer_id }, [
                                    _c(
                                      "td",
                                      {
                                        staticClass:
                                    ...
                                    _vm._v(" "),
                                    _c("td", [
                                      _vm._v(_vm._s(buyer.total_order) + "件")
                                    ])
                                  ])
                                }),
                                0
